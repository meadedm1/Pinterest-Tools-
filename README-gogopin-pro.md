...
|---|---|
| 📌 **Titles** | 3 keyword-rich, click-worthy title options |
| 📝 **Descriptions** | 2 SEO-optimized descriptions with soft CTAs |
| 🔍 **Alt Text** | One field-ready sentence for Pinterest alt text |
| 🏷️ **Keywords** | 7–9 ranked keywords with strength ratings |
| 📊 **Pin Scores** | SEO, Clickability & Saveability scores (1–100) |
...
## ✏️ Input Tips (Better Input = Better Output)
...
- ✅ Use the AI prompts inside Canva AI (Magic Media) or at [ideogram.ai](https://ideogram.ai)
...
**Ideogram tab** — Use this prompt at [ideogram.ai](https://ideogram.ai) for highly stylized, typography-forward pin visuals that stand out in the feed. Ideogram is especially good for pins with text on the image.
...
1. Go to your Pinterest profile → click the **+** to create a new board
2. Use the suggested board name exactly as written
3. Paste the board description into the board's "About" field
4. Save your new pin to the most relevant board first
...
2. Upload `gogopin-pro.html` — rename it to `index.html`
...
1. **Sunday batch** — Generate 5–10 Pin Kits for the week's content
2. **Design** — Use the AI prompts in Canva or Ideogram to create visuals
3. **Schedule** — Upload to Pinterest or queue in Tailwind/Buffer
4. **Review** — Check analytics weekly and note which titles/niches perform best
5. **Repeat** — Use your top-performing pin topics as inputs to generate variations
...
*Generated with ❤️ by Claude for @theugcmaverik*
